            ...
            <div class="col-md-3">
                <div class="footer-item">
                    ...
                    <a href="#" class="footer-link d-flex align-items-start gap-3">
                        <img src="{{ url('public_assets/images/icons/ic-map-marker.svg') }}" alt="">
                        <p>Jl. Mastrip, Krajan Timur, Sumbersari, Kec. Sumbersari, Kabupaten Jember. Jawa Timur
                            68121</p>
                    </a>
                    <a href="#" class="footer-link d-flex align-items-start gap-3">
                        <img src="{{ url('public_assets/images/icons/ic-envelope.svg') }}" alt="">
                        <p>jobqo@gmail.com</p>
                    </a>
                    <a href="#" class="footer-link d-flex align-items-start gap-3">
                        <img src="{{ url('public_assets/images/icons/ic-phone.svg') }}" alt="">
                        <p>082334668379</p>
                    </a>
                </div>
            </div>
            <div class="col-md-3">
                <div class="footer-item ps-lg-5 ps-sm-0">
                    <h4 class="footer-title">Links</h4>

                    <a href="#" class="footer-link">Perusahaan</a>
                    <a href="#" class="footer-link">Tentang Kami</a>
                    <a href="#" class="footer-link">Ikut Bergabung</a>
